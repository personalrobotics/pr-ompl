...
public:
  ...
  void removeVertexWithValue(const gls::datastructures::Vertex vertex,
                             double cost);
  ...
  bool hasVertexWithValue(const gls::datastructures::Vertex vertex,
                          double cost);
...
private:
  ...
  bool
  queueComparison(const std::pair<gls::datastructures::Vertex, double> &,
